...
parser.add_argument('--datapath', help='Path to data folder containing image and annotation files',
                    required=True)
parser.add_argument('--targetpath', help='Path to the target folder',
                    required=True)
...
cwd = os.getcwd()
train_img_path = os.path.join(cwd, f'{target_path}/train/images')
train_txt_path = os.path.join(cwd, f'{target_path}/train/labels')
val_img_path = os.path.join(cwd, f'{target_path}/validation/images')
val_txt_path = os.path.join(cwd, f'{target_path}/validation/labels')
